<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="Ttourism.userprofile" %>
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                            ...
                            <img  width="150px"  src="img/usr-login-img.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                            ...
                            <img  width="100px"    src="img/home-background.jpg" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
                        <center>
                           ...
                           <asp:Label class="badge badge-pill badge-info" ID="Label2" runat="server" Text="your trips info"></asp:Label>
                        </center>
                     </div>
                  </div>
                  <div class="row">
